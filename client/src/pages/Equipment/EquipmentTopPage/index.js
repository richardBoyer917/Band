      ...
      <div className="sectionWrapper">
        <p
          ...
          style={{
            ...
            paddingBottom: "clamp(40px,4.5vw,51px)",
          }}
          onClick={() => {
            window.history.back();
          }}
        ...
        <div className="flexWrapBetween">
          <div
            className="equipmentGallery chichaShow"
            style={{ display: "grid", gap: "clamp(10px, 1vw, 20px)" }}
          >
            ...
            {equipment.images && equipment.images.length > 0 && (
              <>
                <div className="bigEquipmentImageWrappper itemCenter">
                  <img
                    src={`${endpoint}/uploads/equipment/${equipment.images[0]}`}
                    alt="cameraImg1"
                  />
                </div>
                <div className="bigEquipmentImageWrappper itemCenter">
            ...
            <div className="equipmentSmallImage" style={{ gap: "17px" }}>
              {equipment.images && equipment.images.length > 1 && (
                <div className="smallEquipmentImageWrappper itemCenter">
                  <img
                    src={`${endpoint}/uploads/equipment/${equipment.images[1]}`}
                    alt="smailCameraImg1"
                  />
                </div>
              )}
              {equipment.images && equipment.images.length > 2 && (
                <div className="smallEquipmentImageWrappper itemCenter">
                  <img
                    src={`${endpoint}/uploads/equipment/${equipment.images[2]}`}
                    alt="smailCameraImg2"
                  />
                </div>
              )}
          ...
          <div className="equipmentContent">
            ...
            <div
              className="equipmentGallery chichaHidden"
              style={{ display: "grid", gap: "clamp(10px, 1vw, 20px)" }}
            >
              {/* Add conditional rendering to avoid errors */}
              {equipment.images && equipment.images.length > 0 && (
            ...
            >
              <DownloadButton1
                ...
                height="34px"
              />
              <p className="x12_5" style={{ color: "var(--badgeColor)" }}>
                PDF 2.1 Мб
              </p>
            </div>
          </div>
