...
import "../../../styles/pages/cases/casecatalog/caseCatalog.css"
...
const DetailSection = ({ type, data, progress, fieldInfo, checkText }) => {
    ...
    const handleChange = (e) => {
        ...
        setSearchData((prevData) => ({
            ...prevData,
            [name]: type === 'checkbox' ? checked : name === 'capacity' ? marks[value].capacity : value,
        }))
    }
    ...
    return (
        <section className="flexWrapBetween">
                ...
                <Box className='mobileShow '>
                    ...
                    {progress && (
                        <div style={{ paddingBottom: "30px", width: "100%" }}>
                            <label style={{ color: "#FFFFFF", marginBottom: '30px' }}>{progress}</label> <br /> <br />
                            <CustomSlider
                            ...
                            <div className="spaceBetween">
                                {marks.map((item, index) => (
                                    <p key={index} className="slideNumber">{item.label}</p>
                                ))}
                            </div>
                        </div>
                    )}
            ...
            <div className="caseImageSquare flexWrapBetween" style={{ gap: "clamp(20px, 1.5vw, 30px)" }}>
