        ...
        <div className="wrapper">
            <div className='container'>
                <div className='section'>
                    <p className="policyTopLine x30Font_2 ">Политика конфиденциальности</p>
                    <div className='policyAccordion'>
                        {policyAccordion.map((item, index) => (
                            <div className='policyAccordionLine' key={index}>
                                <Accordion className='policyAccordionGap' expanded={selectIndex === index && open}>
                                    <AccordionSummary
                                        expandIcon={selectIndex === index && open ? <img className='policyAddIcon' src={cancelIcon} alt='cancelIcon' /> : <img className='policyAddIcon' src={plusIcon} alt='plusIcon' />}
